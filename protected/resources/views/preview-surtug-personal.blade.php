                              ...
                              <form class="form-horizontal">
                                  ...
                                  <div class="panel panel-default tabs">
                                      ...
                                      <div id="idKonversi" class="panel-body tab-content">
                                          ...
                                          <div class="tab-pane active" id="tab-first">
                                              <div id="sourcehtml" style="">
                                                  <p style="text-align: center;"><img src="img/bps/logoBPS.png" width="80" height="60" /></p>
                                                  <p style="text-align: center;"><strong>SURAT TUGAS</strong></p>
                                                  <p style="text-align: center;">Nomor : 001/62080/02/2019</p>
                                                  <p>&nbsp;</p>
                                                  ...
                                                  <table width="667">
                                                      ...
                                                      <tr style="height: 30.8672px;">
                                                          ...
                                                          <td style="height: 30.8672px;" colspan="2" width="503">
                                                              <p>Melakukan Pencacahan Sakernas ke Bangkal, Seruyan Raya</p>
                                                          </td>
                                                      </tr>
                                                      <tr style="height: 30px;">
                                                          ...
                                                          <td style="height: 30px;" colspan="2" width="503">
                                                              <p>8 Februari 2019 &ndash; 28 Februari 2019</p>
                                                          </td>
                                                      </tr>
                                                      </tbody>
                                                  </table>
                                                  ...
                                                  <table>
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td style="text-align: center;" width="353">
                                                              <p>Kuala Pembuang, 7 Februari 2019</p>
                                          ...
                                          <div class="tab-pane active" id="tab-second">
                                              <div id="source-html" style="margin: 0cm">
                                                  <table style="page-break-before: always">
                                                      <tbody>
                                                      <tr>
                                                          <td rowspan="3" width="90"><p style="text-align: center;"><img src="img/bps/logoBPS.png" width="80" height="60" /></p></td>
                                                          <td width="288">
                                                  ...
                                                  <table >
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td style="width: 293px;">
                                                              <p>Pada Tanggal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 7 Januari 2019</p>
                                                          </td>
                                                      </tr>
                                                      <tr>
                                      ...
                                      <div class="panel-footer">
                                          <button class="btn btn-primary pull-right">Download File </button>
                                      </div>
                                  </div>
